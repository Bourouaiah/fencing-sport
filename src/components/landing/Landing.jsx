      ...
      <div className="flex flex-wrap md:flex-nowrap items-center justify-between px-[50px] py-[20px] space-x-7 relative overflow-hidden z-10">
        <div className="z-10 text-center md:text-left">
          <h1 className="text-4xl xl:text-6xl font-extrabold">
            Welcome to the Algerian Fencing Federation!
          </h1>
          <p className="text-md xl:text-xl font-semibold my-[20px]">
            Unleash Your Potential on the Piste
          </p>
          <p className="text-sm font-medium">
            Discover the artistry and athleticism of fencing through our
            comprehensive training programs and expert coaching. Whether you're
            dreaming of Olympic glory or seeking a new hobby, our federation
            provides the support and resources you need to thrive in the world
            of fencing.
          </p>
        </div>
